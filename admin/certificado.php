            ...
            <form id="details" target="_blank" action="make_certificate.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="p-3 p-lg-5 border">
                  <h3 class="h3 mb-3 text-black">Búsqueda de Estudiante</h2>
                    <div class="col-md-6">
                      <label> Ingrese la cédula del Estudiante:</label></br>
                      <input id="busqueda" name="busqueda" class="textField">
                    </div>
</br>
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="name" name="name" class="textField">
                    </div>

                    <div class="col-md-6">
                      <label> Nombre del Curso aprobado:</label></br>
                      <input id="event" name="event" class="textField">
                    </div>
